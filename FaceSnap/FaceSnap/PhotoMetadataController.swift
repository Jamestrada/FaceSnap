...
class PhotoMetadataController: UITableViewController {
    ...
    init(photo: UIImage) {
        ...
        super.init(style: .Grouped) //creates a table view whose sections present distinct groups of rows
    }
    ...
    private var locationManager: LocationManager! //we don't want to start getting the location until the user taps on the locationLabel row
